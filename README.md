...
This repo declares all external-facing routing, DNS, and WAF (Web Application Firewall) configuration for the Platform Factory. Changes under external/ require approval from the security team.
